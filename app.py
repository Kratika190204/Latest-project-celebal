...
def main():
    ...
    if customer_data is not None:
        ...
        if st.session_state.predictions is not None:
            ...
            with tab4:
                st.subheader(" Risk & Churn Analysis")
                col1, col2 = st.columns(2)
            ...
            with tab5:
                ...
                st.subheader(" High-Risk Customers (Churn Risk > 50%)")
            ...
            with tab6:
                ...
                with col2:
                    ...
                    if clv_metrics['top_10_percent_share'] > 50:
                        st.warning(" High revenue concentration - focus on customer diversification")
                    else:
                    ...
                    if clv_metrics['high_risk_percentage'] > 30:
                        ...
                        st.warning(" Moderate churn risk - proactive retention recommended")
                    else:
    ...
    # Footer with documentation and feedback (always visible)
    st.markdown("---")
    ...
    with col2:
        ...
        """, unsafe_allow_html=True)
        if st.button(" Request Feature", key="request_feature_btn_footer", type="primary", use_container_width=True):
    ...
    col1, col2 = st.columns(2)
    with col1:
        if st.button(" View Documentation", key="view_docs_footer", type="secondary", use_container_width=True):
            doc_handler.display_documentation()
    with col2:
        if st.button(" Provide Feedback", key="provide_feedback_footer", type="secondary", use_container_width=True):
